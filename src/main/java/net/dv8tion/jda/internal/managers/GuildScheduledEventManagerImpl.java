...
public class GuildScheduledEventManagerImpl extends ManagerBase<GuildScheduledEventManager> implements GuildScheduledEventManager
{
    ...
    @Override
    @CheckReturnValue
    public GuildScheduledEventManagerImpl setPermissions(long perms)
    {
    ...
    @Override
    @CheckReturnValue
    public GuildScheduledEventManagerImpl setColor(int rgb)
    {
        this.color = rgb;
        set |= COLOR;
        return this;
    ...
    @Override
    @CheckReturnValue
    public GuildScheduledEventManagerImpl setHoisted(boolean hoisted)
    {
        this.hoist = hoisted;
        set |= HOIST;
        return this;
    ...
    @Override
    @CheckReturnValue
    public GuildScheduledEventManagerImpl setMentionable(boolean mentionable)
    {
    ...
    @Override
    @CheckReturnValue
    public GuildScheduledEventManagerImpl setIcon(Icon icon)
    {
        this.icon = icon;
        this.emoji = null;
        set |= ICON;
    ...
    @Override
    @CheckReturnValue
    public GuildScheduledEventManagerImpl setIcon(String emoji)
    {
        this.emoji = emoji;
        this.icon = null;
        set |= ICON;
    ...
    @Override
    @CheckReturnValue
    public GuildScheduledEventManagerImpl givePermissions(@Nonnull Collection<Permission> perms)
    {
    ...
    @Override
    @CheckReturnValue
    public GuildScheduledEventManagerImpl revokePermissions(@Nonnull Collection<Permission> perms)
    {
        Checks.noneNull(perms, "Permissions");
        setupPermissions();
        return setPermissions(this.permissions & ~Permission.getRaw(perms));
